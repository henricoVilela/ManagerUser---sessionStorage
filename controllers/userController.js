          ...
          this.formEl.addEventListener('submit',(event)=>{
               ...
               this.getPhoto(this.formEl).then(
                    (content)=>{
                         ...
                         values.save();// metodo da classe User responsavel por salvar as informacoes no sessionStorage
          ...
          this.formElUpdate.addEventListener("submit",event => {
               ...
               this.getPhoto(this.formElUpdate).then(
                    (content)=>{
                         ...
                         user.save(); // metodo da classe User responsavel por salvar as informacoes no sessionStorage
     ...
     addEventsTr(tr){
          ...
          tr.querySelector(".btn-delete").addEventListener("click", e=>{
               if(confirm("Deseja realmente excluir?")){
                    ...
                    user.remove();//metodo criado por min
          ...
          tr.querySelector(".btn-edit").addEventListener("click", e=>{
               ...
               let field;
               this.formElUpdate.querySelector('#exampleInputFile').value ='';
